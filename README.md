# Домашнее задание к занятию «Резервное копирование баз данных» Егоров Дмитрий.
...
2.1.Резервное копирование -  pg_dump -h localhost -U username -d database_name -F c -f backup_file.dump  
 ...
 2.1.* Я думаю можно написать задание в планировщике Cron или написать скриптик на Bash-е.  
...
3.1. Например команда - xtrabackup --backup --target-dir=/path/to/inc_backup --incremental-basedir=/path/to/full_backup  
3.1.* Резервные копии можно делать с реплики, не нагружая основной (мастер) сервер. Это снижает влияние на производительность мастер-сервера. Реплики позволяют распределять нагрузку запросов на чтение, снижая нагрузку на мастер.  
